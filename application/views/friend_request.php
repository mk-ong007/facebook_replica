...
<style type="text/css">
	...
	@media (min-width: 576px) {
  	...
  	<div class=" container text-center text-light mt-4" id="mainDiv">
  		<h1 class="p-4"><?php echo count($noOfrequest); ?> Friend Requests</h1>
			      	...
			      	<div class="row">
			      		<div class="p-2 dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="confirm">
								<li><a href="<?php echo base_url('friend/confirm_request/').$value->id ?>" class="dropdown-item" >Accept</a></li>
							    <li><a href="<?php echo base_url('friend/delete_request/').$value->id ?>" class="dropdown-item" >Delete</a></li>
							</ul>
						</div>
						<div class="p-2">
							<a style="width: 130px" href="" class=" btn btn-secondary messageBtn" data-bs-toggle="modal" data-bs-target="#messageOpen"><i class=" fab fa-facebook-messenger p-1"></i>Message</a>
						</div>
					</div>
 	...
 	if($noOfrequest == 0)
 	{
		echo "<tr><td colspan='3'>No requests received !</td></tr>";
 	}
 	 ?>
